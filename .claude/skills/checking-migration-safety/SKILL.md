...
description: Use when a change touches persisted data shape — expand-contract and prove the down-migration. [Internal discipline — applied automatically by pipeline agents mid-task; direct use is a power-user path.]
---
